                ...
                <div class="col-md-6">
                    <div class="p-3 right-side">
                        ...
                        <div class="buttons d-flex flex-row mt-5">
                            <button class="btn btn-outline-dark" style="margin-right: 10px;" onclick="showCheckout()">Buy Now</button>
                            <button class="btn btn-dark" onclick="showCart()">Add to Cart</button>
                        </div>
                    </div>
                </div>
            </div>
